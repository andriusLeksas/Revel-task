...
function convertNumberToEnglishText(n) {
    ...
    var under20_digit_numbers = new Map([['0', ' zero'], ['1', ' one'], ['2', ' two'], ['3', ' three'], ['4', ' four'], ['5', ' five'],
        ['6', ' six'], ['7', ' seven'], ['8', ' eight'], ['9', ' nine'], ['10', ' ten'], ['11', ' eleven'], ['12', ' twelve'],
        ['13', ' thirteen'], ['14', ' fourteen'], ['15', ' fifteen'], ['16', ' sixteen'], ['17', ' seventeen'], ['18', ' eighteen'], ['19', ' nineteen']]);
    var double_digit_numbers = new Map([['1', ' ten'], ['2', ' twenty'], ['3', ' thirty'], ['4', ' forty'], ['5', ' fifty'], ['6', ' sixty'],
    ...
    while (n > 0.5) {
        switch (n.toString().length) {
            ...
            case 5:
                ...
                break;
            default:
                convertedNumber = 'Something is wrong with the number';
                break;
        }
    }
    return convertedNumber.trim();
